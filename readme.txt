...
* 注意
現時点ではユーザーIDからショートを取れません
ショート一覧からもショート動画全部を取れません
やる気がないので改修予定はまだありません
ショート動画そのもののURLを読み込ませてください

2026/08/16
・jsonオプション is_download_finish_list_not_clearを追加しました
これをtrueにするとダウンロードが終了してもリストが消えなくなります
・リストクリアコマンド追加

2026/06/28
・たぶんショート動画に対応しました(urlはshortsではなくwatchを使ってください)
・shorts含みの動画URLを受け入れます
・ユーザー名取得のやり方を変えました

2026/06/13
・○が一部違ってたのを修正
・リストファイル出力をなくして代わりにクリップボードに出力するように
