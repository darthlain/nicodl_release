...
2025/04/02
[メモだけ]
ひょっとしたら今のだと投稿者コメントがたくさんあったら全部取れないかも
実験したいけど1postで取り切れないくらい大量に投稿者コメントがある動画を知らない

現状動画DL失敗してもコメントが取得できてれば失敗扱いにならない これは問題かも

msvcrt.getchを使用してるせいでwindows意外だと使えない？

yt-dlpでDLできないときはログインすれば解決するかも
...
2025/02/18
・yt_dlp_pathのデフォルト設定に--write-thumbnailを追加しました
  (デフォルトでサムネイル画像を取得するように)

2025/02/14
・↓の修正に不備があったので修正

2025/02/11
・nicozonの投稿動画が何故か実際より少ない件数になってしまうのでnicovideoから取るようにしました
  マイリストは今のところ大丈夫っぽいので変えてません
...
comment_mailとcomment_passは現状推奨しません 作っちゃったからとりあえず残しているみたいな感じです
